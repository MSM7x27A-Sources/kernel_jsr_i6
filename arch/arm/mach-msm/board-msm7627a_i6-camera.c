...
sensor_board_info_ov8825.cam_vreg = ov8825_gpio_vreg;
		...
		msm_camera_sensor_ov8825_data.sensor_reset = GPIO_SKU3_CAM_5MP_CAMIF_RESET;
		msm_camera_sensor_ov8825_data.sensor_pwd = GPIO_SKU3_CAM_5MP_SHDN_N;
		sensor_board_info_ov8825.mount_angle = 90;  //modify by hanjue
...
static void i6_camera_gpio_cfg(void)
{
	...
	if (rc < 0)
		pr_err("%s: gpio_request ov8825 sensor_pwd: %d failed!",
			 __func__, GPIO_SKU3_CAM_5MP_SHDN_N);
	...
	rc = gpio_direction_output(GPIO_SKU3_CAM_5MP_SHDN_N, 1);
	if (rc < 0)
		pr_err("%s: unable to set gpio: %d direction for ov8825 camera\n",
			__func__, GPIO_SKU3_CAM_5MP_SHDN_N);

	rc = gpio_request(GPIO_SKU3_CAM_5MP_CAMIF_RESET, "ov8825");
	if (rc < 0)
		pr_err("%s: gpio_request ov8825 sensor_reset: %d failed!",
			 __func__, GPIO_SKU3_CAM_5MP_CAMIF_RESET);
